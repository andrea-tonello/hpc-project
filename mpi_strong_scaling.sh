...
echo "nodes,tasks,elapsed,computation,communication" > ${OUTFILE}
...
for NODES in 1 2 4 8 16; do
    ...
    echo "Running with ${NODES} nodes (${TOTAL_TASKS} MPI tasks)"
    ...
    echo "${NODES},${TOTAL_TASKS},${ELAPSED},${COMP},${COMM}" >> ${OUTFILE}
